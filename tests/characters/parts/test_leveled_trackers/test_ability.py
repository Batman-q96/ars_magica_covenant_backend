...
from characters.parts.leveled_trackers import ability
...
class TestAbility:
    ...
    def ability_fixture(self) -> ability.Ability:
        ...
        return ability.Ability(
            name="Test Ability", specialization="Test Specialization"
        )
    ...
    def test_create_with_experience(self):
        ...
        assert ability.Ability(
            name="Test Ability", experience=2, specialization="Test Specialization"
        )
    ...
    def test_add_experience(self, ability_fixture: ability.Ability):
        ...
        ability_fixture.add_points(20)
        assert ability_fixture.level == 2
        assert ability_fixture.points == 5
